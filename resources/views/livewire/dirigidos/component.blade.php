<div>
    ...
    @if ($action == 1)
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div>
                                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">
                                        <i class="bi bi-person-lines-fill"></i> Módulo de Destinatarios
                                    </h2>
                                ...
                                <div>
                                    <div class="inline-flex gap-x-2">
                                        @include('common.dirigidos.search')
                            ...
                            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                                ...
                                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                                    @foreach ($dirigido as $d)
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4"> {{ $d->id }}</td>
                                            <td class="px-6 py-4"> {{ $d->nombre }}</td>
                                            <td class="px-6 py-4"> {{ $d->cargo}}</td>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex justify-end gap-4">
                                                    ...
                                                    @include('common.dirigidos.actions')
        ...
        @elseif($action == 2)
            @include('livewire.dirigidos.edit')
