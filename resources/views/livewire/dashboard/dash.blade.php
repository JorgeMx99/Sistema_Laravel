    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div
            ...
            <div class="p-4 md:p-6">
                <span class="block text-center mb-1 text-xs font-semibold uppercase text-blue-600 dark:text-blue-500">
                    Usuarios
                </span>
                <h3 class="text-xl text-center font-semibold text-gray-800 dark:text-gray-300 dark:hover:text-white">
                    Total de Usuarios
                </h3>
        ...
        <div
            ...
            <div class="p-4 md:p-6">
                <span class="text-center block mb-1 text-xs font-semibold uppercase text-rose-600 dark:text-rose-500">
                    Registros
                </span>
                <h3 class="text-center text-xl font-semibold text-gray-800 dark:text-gray-300 dark:hover:text-white">
                    Total de Registros
                </h3>
                <p class="text-center mt-3 text-gray-500">
        ...
        <div
            ...
            <div class="p-4 md:p-6">
                <span class="text-center block mb-1 text-xs font-semibold uppercase text-amber-500">
                    Roles
                </span>
                <h3 class="text-center text-xl font-semibold text-gray-800 dark:text-gray-300 dark:hover:text-white">
                    Total de Roles
